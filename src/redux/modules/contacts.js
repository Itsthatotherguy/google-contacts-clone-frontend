...
const OPEN_EDIT_CONTACT_DIALOG_STARTED = 'contacts/OPEN_EDIT_CONTACT_DIALOG_STARTED';
const OPEN_EDIT_CONTACT_DIALOG_WITH_CACHED_DATA =
    '/contacts/OPEN_EDIT_CONTACT_DIALOG_WITH_CACHED_DATA';
const OPEN_EDIT_CONTACT_DIALOG_SUCCEEDED = 'contacts/OPEN_EDIT_CONTACT_DIALOG_SUCCEEDED';
const OPEN_EDIT_CONTACT_DIALOG_FAILED = 'contacts/OPEN_EDIT_CONTACT_DIALOG_FAILED';
